...
@section('content')
    <main class="mx-auto max-w-container">
        ...
        <section class="relative left-1/2 w-screen -translate-x-1/2 bg-[#F7F7FA]">
            <div class="mx-auto max-w-container bg-[#F7F7FA] py-10 xl:py-24 px-3 md:px-7">
                <h2 class="m-0 font-normal leading-none text-black md:text-3xl xl:text-4xl 2xl:text-5xl">Описание</h2>
                <p class="mt-3 text-black md:text-lg xl:text-xl">
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-4xl 2xl:text-5xl">Как этого избежать?</h2>
                <div class="rounded-lg bg-button-bg/15">
                    <p class=" mt-3 px-3 py-5 text-black md:px-5 md:text-lg xl:py-10 xl:text-xl">
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-4xl 2xl:text-5xl">ИТ-консалтинг — состав услуги</h2>
                <p class="mt-3 text-black md:text-lg xl:text-xl">
                ...
                <ul class="my-5 list-none space-y-4 p-0 text-black md:text-lg xl:text-xl">
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-4xl 2xl:text-5xl">Разработка стратегии развития ИТ</h2>
                <p class="mt-3 text-black md:text-lg xl:text-xl">
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-4xl 2xl:text-5xl">Стоимость ИТ-консультации</h2>
                <p class="mt-3 text-black md:text-lg xl:text-xl">
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-4xl 2xl:text-5xl">Преимущества ИТ-консалтинга</h2>
                <p class="mt-3 text-black md:text-lg xl:text-xl">
                    Стоимость услуг IT-консалтинга формируется индивидуально, учитывая как качественные, так и
                    количественные показатели. Итоговая сумма зависит от размера и сложности ИТ-инфраструктуры заказчика, а
                    также от объёма необходимых консалтинговых услуг, определяемого временем, затраченным экспертами
                ...
                <h2 class="xl:mt-30 m-0 mt-5 font-normal leading-none text-black md:mt-10 md:text-3xl xl:text-3xl xl:text-4xl 2xl:text-5xl">Почему КИТ</h2>
                <ul class="my-5 list-none space-y-4 p-0 text-black md:text-lg xl:text-xl">
                    <li class="mb-2 flex items-center gap-2 xl:gap-3">
                        <img class="w-2 2xl:w-3" src="/images/pentagon.svg">
