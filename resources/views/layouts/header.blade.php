<header class="group relative mx-auto flex max-w-container justify-between px-3 py-4 md:p-7">
    ...
    <nav
        class="md:top-22 fixed left-0 top-12 flex hidden h-[calc(100vh-64px)] w-full flex-col gap-10 bg-white px-3 pt-12 text-[#0E1014] group-[.header--menu-shown]:flex xl:static xl:flex xl:h-auto xl:w-[750px] xl:flex-row xl:items-center xl:bg-inherit xl:p-0 xl:text-primary">
        <ul class="xl:w-188 m-0 flex list-none flex-col gap-7 p-0 xl:flex-row xl:justify-center xl:gap-4">
            <li class="group/services relative flex items-center justify-between xl:list-item">
                <a class="cursor-context-menu items-center text-sm uppercase group-hover/services:text-button-bg">Услуги
                ...
                <ul
                    ...
                    <li class="dropdown-arrow group/services-item mr-6 flex items-center justify-between">
                        ...
                        <ul
                            class="invisible absolute left-80 -top-4 z-50 w-80 list-none rounded-md bg-primary p-0 py-4 text-black opacity-0 shadow-lg transition-all duration-300 group-hover/services-item:visible group-hover/services-item:opacity-100">
                            <li>
            ...
            <li class="group/portfolio relative xl:mr-130">
                <a class="text-sm uppercase text-inherit no-underline transition-all duration-200 ease-in hover:text-button-bg" href="#">Портфолио
            ...
            <li class="group/company relative flex items-center justify-between xl:list-item">
                <a class="cursor-context-menu text-sm uppercase text-inherit no-underline transition-all duration-200 ease-in group-hover/company:text-button-bg" href="#">Компания</a>
                <svg class="h-4 w-4 xl:hidden">
                    <use href="#icon-double-chevron-down"></use>
                </svg>
                <!-- dropdown -->
            ...
            <li class="group/career relative flex items-center justify-between xl:list-item">
                <a class="cursor-context-menu text-sm uppercase text-inherit no-underline transition-all duration-200 ease-in group-hover/career:text-button-bg" href="#">Карьера</a>
                <svg class="h-4 w-4 xl:hidden">
                    <use href="#icon-double-chevron-down"></use>
                </svg>
                <!-- dropdown -->
            ...
            <li>
                <a class="text-sm uppercase text-inherit no-underline transition-all duration-100 ease-in hover:text-button-bg" href="#">Контакты</a>
            </li>
        </ul>
