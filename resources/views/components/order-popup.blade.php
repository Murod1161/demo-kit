<div class="order-popup fixed left-0 top-0 flex hidden h-screen w-screen items-center justify-center bg-black/50 transition-all duration-300">
    <div class="w-140 relative rounded-lg bg-white p-5 md:p-10 text-secondary">
        ...
        <form class="flex justify-between gap-5" action="">
            ...
            <input class="w-full rounded-lg border border-secondary/50 px-2 py-1 md:px-3 md:py-2 shadow-sm focus:border-button-bg focus:outline-none focus:ring-1 focus:ring-button-bg" name="phone" type="phone"
                placeholder="Номер телефона">
        </form>
        <div class="">
            <button class="w-full cursor-pointer rounded-md border-0 bg-button-bg px-3 py-3 font-futura text-xs/3 uppercase text-white transition hover:bg-[#5b5fe6] md:px-4 md:py-3 md:text-sm"
                type="submit">Заказать</button>
        </div>
        <div class="mt-5 flex items-center gap-2">
            <input id="consent" name="consent" type="checkbox" required />
            <label class="text-base leading-none" for="consent">
